...
Shader "EROR"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 panner45 = ( mulTime44 * float2( 0.27,-0.79 ) + float2( 0.06,0.24 ));
			float2 uv_TexCoord42 = i.uv_texcoord * temp_cast_0 + panner45;
			float simplePerlin3D40 = snoise( float3( uv_TexCoord42 ,  0.0 ) );
			float2 temp_cast_2 = (2.76).xx;
			float mulTime47 = _Time.y * 3.09;
			float2 panner48 = ( mulTime47 * float2( -1.71,-0.88 ) + float2( -1.34,-0.38 ));
			float2 uv_TexCoord50 = i.uv_texcoord * temp_cast_2 + panner48;
			float simplePerlin3D51 = snoise( float3( uv_TexCoord50 ,  0.0 ) );
			float4 color23 = IsGammaSpace() ? float4(1.614676,0.7569249,0.2208756,0.3411765) : float4(2.86938,0.5333745,0.03998581,0.3411765);
			...
			float4 color21 = IsGammaSpace() ? float4(0.8950655,0.9339623,0.4890085,0.3058824) : float4(0.7776832,0.8562991,0.2040083,0.3058824);
			...
			float4 color17 = IsGammaSpace() ? float4(1.892181,1.563108,0,0.4352941) : float4(4.067411,2.671627,0,0.4352941);
...
/*ASEBEGIN
Version=16700
2162;73;1401;523;1633.788;2039.329;3.29627;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;46;615.8886,-1789.548;Float;True;Constant;_Float0;Float 0;1;0;Create;True;0;0;False;0;3.09;0;3;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-128.136,-1256.876;Float;True;Constant;_FAST;FAST;1;0;Create;True;0;0;False;0;7.9;0;3;14;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;19;-59.05776,-713.1102;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;47;908.738,-1599.72;Float;True;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.LightColorNode;34;-127.2564,-488.9198;Float;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleTimeNode;44;176.1413,-1069.686;Float;True;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;41;83.6543,-1569.23;Float;True;Constant;_EUUUGH;EUUUGH;1;0;Create;True;0;0;False;0;0.8;0;0.4;1.68;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PannerNode;45;392.4079,-1007.341;Float;True;3;0;FLOAT2;0.06,0.24;False;2;FLOAT2;0.27,-0.79;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;49;1190.012,-1906.95;Float;True;Constant;_Float1;Float 1;1;0;Create;True;0;0;False;0;2.76;0;2.79;2.79;0;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;48;1133.794,-1540.012;Float;True;3;0;FLOAT2;-1.34,-0.38;False;2;FLOAT2;-1.71,-0.88;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;42;704.1422,-1090.86;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;50;1445.527,-1623.532;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;40;978.2384,-973.546;Float;True;Simplex3D;1;0;FLOAT3;0.54,0.84,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;51;1668.185,-1332.122;Float;True;Simplex3D;1;0;FLOAT3;0.54,0.84,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;16;178.8106,-88.39312;Float;True;Color Mask;-1;;3;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;1.73;False;5;FLOAT;-0.6;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;52;1501.737,-794.9119;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;53;602.6827,-1368.969;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=045575ED40785288BD20A780589AD6E8A35F085E